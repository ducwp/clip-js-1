  ...
  reducers: {
    ...
    setAspectRatio: (state, action: PayloadAction<string>) => {
      ...
      switch (action.payload) {
        case "16:9":
          state.resolution = { width: 1280, height: 720 };
          break;
        case "9:16":
          state.resolution = { width: 720, height: 1280 };
          break;
        case "1:1":
          state.resolution = { width: 800, height: 800 };
          break;
        case "4:3":
          state.resolution = { width: 960, height: 720 };
          break;
        case "4:5":
          state.resolution = { width: 576, height: 720 };
          break;
        case "21:9":
          state.resolution = { width: 1680, height: 720 };
          break;
        case "2:3":
          state.resolution = { width: 720, height: 1080 };
          break;
        default:
          state.resolution = { width: 720, height: 1280 };
      }
