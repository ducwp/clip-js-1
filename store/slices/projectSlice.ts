    ...
    reducers: {
        ...
        setAspectRatio: (state, action: PayloadAction<string>) => {
            ...
            switch (action.payload) {
                case '16:9':
                    state.resolution = { width: 1920, height };
                    break;
                case '9:16':
                    state.resolution = { width: 1080, height: 1920 };
                    break;
                case '1:1':
                    state.resolution = { width: 1080, height: 1080 };
                    break;
                case '4:3':
                    state.resolution = { width: 1440, height: 1080 };
                    break;
                case '4:5':
                    state.resolution = { width: 864, height: 1080 };
                    break;
                case '21:9':
                    state.resolution = { width: 2520, height: 1080 };
                    break;
                case '2:3':
